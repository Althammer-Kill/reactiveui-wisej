...
namespace ReactiveUI.Wisej
{
	...
	public partial class ReactiveUserForm<T> : Form, IViewFor<T>, INotifyPropertyChanged, ICanActivate
		where T : class, INotifyPropertyChanged
	{
		...
		private bool ViewModelBound = false;
		...
		/// <inheritdoc />
		public new IObservable<Unit> Activated => initSubject.AsObservable();

		/// <inheritdoc />
		public IObservable<Unit> Deactivated => deactivateSubject.AsObservable();

		protected ReactiveUserForm()
		{
        ...
        {
	        if (ViewModelBound)
		        throw new Exception("ViewModel was bound twice! Make sure to only call BindViewModel once in the final child class!");
